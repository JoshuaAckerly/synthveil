...
- **SSR Server**: http://localhost:13719
...
3. **Database Setup**
   ...
   DB_CONNECTION=mysql
   DB_DATABASE=synthveil
   DB_USERNAME=synthveil
...
5. **Start Servers**
   ...
   # Terminal 3: SSR
   php artisan inertia:start-ssr --port=13719
   ```
...
|---------|------|---------|
| Laravel | 8004 | Main application server |
| Vite | 5176 | Development build server with HMR |
| SSR | 13719 | Inertia.js server-side rendering |
...
INERTIA_SSR_URL=http://127.0.0.1:13719
```
...
3. Ensure database exists: `CREATE DATABASE synthveil;`
4. Run migrations: `php artisan migrate`

### SSR Not Working

1. Verify `.env` has `INERTIA_SSR_ENABLED=true`
2. Check SSR server is running on port 13719
