#!/bin/bash
# Test Server Deployment Script for SynthVeil
...
if command -v supervisorctl &> /dev/null; then
    ...
    sudo supervisorctl restart synthveil-worker:* 2>/dev/null || echo "No queue workers configured yet"
fi
...
echo "=================================="
echo "🌐 Your site should now be live at test-synthveil.yourdomain.com"
